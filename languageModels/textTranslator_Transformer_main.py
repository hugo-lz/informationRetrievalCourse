...
with open("data/traductorFrasesEnEs.txt",  encoding='utf-8') as f:
    lines = f.read().split("\n")[:-1]
text_pairs = []
for line in lines:
    eng, spa = line.split("\t")
...
x = TransformerDecoder(embed_dim, latent_dim, num_heads)([x, encoded_seq_inputs])  # Use encoded_seq_inputs here
...
transformer = keras.Model(
    [encoder_inputs, decoder_inputs],  # List of inputs instead of dict
    decoder([decoder_inputs, encoder(encoder_inputs)]),  # Proper connection
    name="transformer"
)
